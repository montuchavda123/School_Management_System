...
def login():
    ...
    elif usernameEntry.get() == "Montu" and passwordEntry.get() == "12345":
...
backgroudImage=ImageTk.PhotoImage(file="bg.jpg")
bgLabel=Label(window,image=backgroudImage)
...
loginButton=Button(loginFrame,text="Login",font=("times new roman",14,"bold")
                  ,width=15,fg="white",bg="cornflowerblue",cursor="hand2"
